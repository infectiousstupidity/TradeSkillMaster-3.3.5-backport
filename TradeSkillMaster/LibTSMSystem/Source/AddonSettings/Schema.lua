...
function Schema.Get()
	...
	return Settings.NewSchema(136, 10)
		...
		:EnterScope("factionrealm")
			...
			:LeaveNamespace()
			:EnterNamespace("auctioningOptions")
				:If(LibTSMSystem.IsVanillaClassic() or LibTSMSystem.IsBCClassic() or LibTSMSystem.IsWrathClassic())
