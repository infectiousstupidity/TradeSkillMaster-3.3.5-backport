...
-- WotLK has six distinct vellums. This compatibility table maps each stock
-- WotLK enchant spell to the canonical minimum vellum used by historical TSM
-- data. Higher tiers can substitute in-game, but a canonical target keeps the
-- price, gathering requirement, and vellum actually consumed consistent.
-- Blade Ward (64441) and Blood Draining (64579) use corrected Weapon Vellum III
-- entries from later TSM data.
Enchant.WrathVellumItemIds = {
	[7418] = 38682,
	[7420] = 38682,
	[7426] = 38682,
	[7428] = 38682,
